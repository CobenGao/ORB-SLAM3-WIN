...
void System::SaveTrajectoryTUM(const string &filename)
{
    ...
    f << "#TUM format" << endl;
    f << "#timestamp[s] p_RS_R_x[m] p_RS_R_y[m] p_RS_R_z[m] q_RS_x[] q_RS_y[] q_RS_z[] q_RS_w[]" << endl;
...
void System::SaveTrajectoryEuRoC(const string &filename)
{
    ...
    f << "#Euroc format" << endl;
    f << "#timestamp[ns],p_RS_R_x[m],p_RS_R_y[m],p_RS_R_z[m],q_RS_w[],q_RS_x[],q_RS_y[],q_RS_z[]" << endl;
...
void System::SaveTrajectoryKITTI(const string &filename)
{
    ...
    list<double>::iterator lT = mpTracker->mlFrameTimes.begin();
    f << "#Kitti format" << endl;
    f << "#r11 r12 r13 tx r21 r22 r23 ty r31 r32 r33 tz" << endl;
    for(list<Sophus::SE3f>::iterator lit=mpTracker->mlRelativeFramePoses.begin(),
